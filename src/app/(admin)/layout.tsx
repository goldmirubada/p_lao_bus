...
import { LogOut, LayoutDashboard, Map, MapPin, Edit3, Bus, Menu, X, MessageSquare, Bug } from 'lucide-react';
...
export default function AdminLayout({ children }: { children: ReactNode }) {
    ...
    const navItems = [
        ...
        { href: '/admin/errors', label: '시스템 오류 모니터링', icon: Bug },
    ];
        ...
        <div className="flex h-screen bg-slate-50">
            ...
            `}>
                ...
                <div className="p-4 border-t border-slate-100">
                    <button
                        onClick={signOut}
                        className="flex items-center gap-3 w-full px-4 py-3 text-sm font-medium text-red-600 hover:bg-red-50 rounded-lg transition-colors min-h-[44px]"
                    >
                        <LogOut size={18} /> 로그아웃
                    </button>
                </div>
