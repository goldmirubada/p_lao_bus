...
import { X, MapPin, Navigation, Bus, Clock, RefreshCw, Map as MapIcon } from 'lucide-react';
                                            ...
                                            <div className="font-bold text-slate-700 text-sm flex items-center gap-2">
                                                {segment.routeId === 'WALK' ? (
                                                    ...
                                                    <>
                                                        ...
                                                        <span className="text-green-700">{t('bus_segment' as any)} {segment.description}</span>
                                                    </>
                                                )}
                                            </div>
