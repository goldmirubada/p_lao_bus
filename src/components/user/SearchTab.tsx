...
export default function SearchTab({
    ...
    return (
        <div className="flex flex-col h-auto lg:h-full bg-slate-50">
            ...
            <div className="flex-1 flex flex-col min-h-0 overflow-visible lg:overflow-hidden">
                {query ? (
                    /* Search Results */
                    ...
                    selectedRoute !== 'all' ? (
                        <div className="flex-1 flex flex-col min-h-0 overflow-visible lg:overflow-hidden">
                            <div className="px-4 py-2 bg-slate-50 text-xs font-bold text-slate-500 uppercase tracking-wider sticky top-0 border-b border-slate-100 mb-2 z-10">
                                {t('route_stops') || '정류장 목록'}
                            </div>
                            <div className="flex-1 overflow-visible lg:overflow-y-auto px-4 pb-4">
                                {(() => {
